...
| 2750-54242-0547 @ 6856.46 Å (F5) | **KILLED (most plausibly) — Hα of a z ≈ 0.0445 galaxy group member in the fibre** (recheck2 run 35871849633). A star-forming SDSS galaxy at z = 0.04502 sits **15.2″** away (fibre 461 — its Hα is at 6856.4 Å, dv = 162 km/s), and SDSS photometry has a type-GALAXY source (r = 22.4) at 5.5″ and a faint source (r = 22.8) at 3.6″. The line is present again in **LAMOST** obsid 343612058 (2015-04-23, 8 yr later, a different instrument): 12.9 σ, EW 5.3 Å (vs 1.6 Å in SDSS; an offset extended source gives a fibre-dependent EW), centre 6856.65 Å, FWHM 4.77 ± 0.43 Å; the OH 6866 residual there is −0.3 σ. Position-locked, wavelength-locked, at the group's Hα. Not molecular: SDSS and LAMOST both type it F5; a 40-star F5 template reads −2.1 σ at 6856.5, and target/template still shows 6.1 σ, EW 1.65 Å. Width 1.19 ± 0.14 × the pixel-unit LSF. SPARCL at 3″ holds no other spectrum (no DESI, BOSS or eBOSS); APOGEE is H-band and cannot cover 6856 Å. The companion lines are not detected (≤ 3.4 σ) — as for 0412, one F5-dominated epoch is too shallow — so this is an identification by redshift coincidence and position, not by a line family. Earlier checks: (recheck runs 35867493090, 35868182768: the plate co-detections are galaxies — fibre 461 is Hα of a z = 0.0450 star-forming galaxy (7 calibrated companions), 569/630 are [S II] 6716 at z ≈ 0.021, 414 does not reproduce (−0.7 σ), 302 is a z = 0.166 starburst at 4.1 σ with no line at λ; the nearest sky-model peak is at 6865.6–6866.5 Å vacuum (OH 6863.96 air = 6865.86 vac), 9.1–9.8 Å away, with the sky at the line 0.88–0.95 × local median, and the per-exposure flux anti-correlates with the sky (r = −0.95, n = 3); the other plates observed on MJD 54242 (2157, 2766) have 2 of 117 fibres ≥ 5 σ, the random rate. What follows is the earlier note.) | Only 3 exposures (2 present), calibrated coadd 5.9 σ; OH line 9.3 Å away. Width 0.93 × sky LSF. Same-type F5 0/40, any-star 0/39, but **3 of 24 random fibres of plate 2750** read 4.8, 6.3, 14.3 σ at the same wavelength (two in the same spectrograph) against ~1/24 on other plates — not significant on its own (p ≈ 0.25) and not yet checked for being galaxies. No nebular family (best 3.4 σ). |
