...
REFS: dict[str, dict] = {
    ...
    "ErrorCatastrophe2016": {"mode": "arxiv_id", "id": "1605.02169", "expect": "Why is there no von Neumann probe on Ceres? Error catastrophe can explain the Fermi-Hart Paradox"},
    "LotkaVolterra2022": {"mode": "arxiv_id", "id": "2209.14244", "expect": "Lotka-Volterra Models for Extraterrestrial Self-Replicating Probes"},
    ...
    "Wyatt2008": {"mode": "arxiv_id", "id": "0807.1272", "expect": "Evolution of Debris Disks"},
    ...
    "Moor2021": {"mode": "arxiv_id", "id": "2103.00568", "expect": "New insights into the nature of transient extreme debris disks"},
